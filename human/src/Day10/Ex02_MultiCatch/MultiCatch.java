...
public class MultiCatch {
	...
	public static void main(String[] args) {
		...
		try {
			...
			char[] char1 = str1.toCharArray();  // 문자열 str1을 -> char[] 변환
			char[] char2 = str2.toCharArray();  // Ex > 문자열 "10" -> [1][0]
		...
		// 하나의 catch 블로에서 처리하고 싶은 예외는 |(or) 로 연결하여 사용한다
		// 	| : 비트연산, 논리연산과 논외로 이렇게 쓰기로 정의해놓음
			...
			// 상위 예외 크래스가 하위 예외 클래스보다 아래쪽에 위치해야한다
			System.out.println("이 외의 알수없는 예외 발생");
